...
const STATUS_CONFIG = {
	...
	rejected:  { bg: 'bg-danger-subtle',   text: 'text-danger',  icon: 'times-circle', label: 'Rejected'  },
	no_show:   { bg: 'bg-danger-subtle',   text: 'text-danger',  icon: 'times-circle', label: 'No Show'   },
};
