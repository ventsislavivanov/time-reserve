...
export { default as HistoryAppointments } from './worker/HistoryAppointments.jsx';

export { default as AdminAppointments } from './admin/AdminAppointments.jsx';

export { getStaffAppointments } from './services/appointmentService.js';